...
nav {
      ...
      background-image: -moz-linear-gradient(bottom, #660000 0%, #ff0011 81%);
      background-image: linear gradient(bottom, #660000 0%, #ff0011 81%);
      background-image: -ms-linear-gradient(bottom, #660000 0%, #ff0011 81%);
      background-image: -webkit-linear-gradient(bottom, #660000 0%, #ff0011 81%);
  height: 50px;
  overflow: hidden;
}
